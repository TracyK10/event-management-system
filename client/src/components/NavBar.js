...
function NavBar() {
  return (
    <nav class="bg-slate-300 flex justify-between">
      <img src={Logo} alt="" className="h-16 ml-4 mt-2" />
      <ul className="flex py-5 space-x-10 justify-end mr-11">
        <Link to ="/"><li className="cursor-pointer">Home</li></Link>
        <Link to ="/event-form"><li className="cursor-pointer">Create Event</li></Link>
        <Link to ="/events"><li className="cursor-pointer">My events</li></Link>
